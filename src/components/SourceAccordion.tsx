...
export const SourceAccordion: React.FC = () => {
  ...
  return (
    <div className="h-full flex flex-col">
      <div id="accordion-nested-parent" className="w-full h-[710px] overflow-y-scroll p-2">
        ...
        <div className="flex flex-col bg-[#FFFFFF] mb-4 mt-4 mx-2 border-[1px] rounded-xl border-[#ECECEC] shadow-md">
          ...
          >
            <p className="text-black">What is the purpose of KVM extenders and switch in the ...</p>
            <svg
              className={`w-3 h-3 transform ${openSection.parent === "1" ? "" : "rotate-180"}`}
              aria-hidden="true"
          ...
          <hr className={`border-gray-300 ${openSection.parent === "1" ? "opacity-100" : "opacity-0"} transition`} />
          <div className={`transition ${openSection.parent === "1" ? "opacity-100" : "opacity-0"}`} data-accordion="collapse">
                      ...
                      <div className="py-2">
                        ...
                        <div className="flex flex-col bg-blue-50 rounded-xl border border-blue-100">
                          ...
                          >
                            ...
                            <svg
                              className={`w-3 h-3 transform ${openSection.source === "sourceNested1" ? "" : "rotate-180"}`}
                              aria-hidden="true"
                              xmlns="http://www.w3.org/2000/svg"
                              fill="none"
                              viewBox="0 0 10 6"
                          ...
                          <div className={`transition ${openSection.source === "sourceNested1" ? "opacity-100" : "opacity-0"}`}>
                            {openSection.source === "sourceNested1" && (
                              <div className="px-3 pb-2 -mt-2">
                                ...
                                <a
                                  ...
                                  onClick={() => showPreview("sourceNested1Preview")}
                                >
                                  {openSection.preview === "sourceNested1Preview" ? "Hide Preview" : "View Preview"}
                                </a>
                                {openSection.preview === "sourceNested1Preview" && (
                                  <div>
        ...
        <div className="flex flex-col bg-[#FFFFFF] mb-4 mt-4 mx-2 border-[1px] rounded-xl border-[#ECECEC] shadow-md">
          ...
          >
            <p className="text-black">How does financial analysis help stakeholders make infor...</p>
            <svg
              className={`w-3 h-3 transform ${openSection.parent === "2" ? "" : "rotate-180"}`}
              aria-hidden="true"
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 10 6"
          ...
          <hr className={`border-gray-300 ${openSection.parent === "2" ? "opacity-100" : "opacity-0"} transition`} />
          <div className={`transition ${openSection.parent === "2" ? "opacity-100" : "opacity-0"}`}>
                        ...
                        <div className="flex flex-col bg-blue-50 rounded-xl border border-blue-100">
                          ...
                          <div className={`transition ${openSection.source === "sourceNested1" ? "opacity-100" : "opacity-0"}`}>
                            {openSection.source === "sourceNested1" && (
                              <div className="px-3 pb-2 -mt-2">
                              <p className="text-gray-500">
                                  Discusses the importance of financial reports in evaluating an organization's performance and supporting stakeholder decision-making through comprehensive financial data analysis.
                                </p>
                                <a
                                  className="text-blue-600 hover:underline cursor-pointer"
                                  onClick={() => showPreview("sourceNested1Preview")}
        ...
        <div className="flex flex-col bg-[#FFFFFF] mb-4 mt-4 mx-2 border-[1px] rounded-xl border-[#ECECEC] shadow-md">
          <div
            ...
            id="accordion-collapse-heading-1"
          >
            <p className="text-black">Why are budgeting and forecasting considered crucial for...</p>
            <svg
              className={`w-3 h-3 transform ${openSection.parent === "3" ? "" : "rotate-180"}`}
              aria-hidden="true"
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 10 6"
          ...
          <hr className={`border-gray-300 ${openSection.parent === "3" ? "opacity-100" : "opacity-0"} transition`} />
          <div className={`transition ${openSection.parent === "3" ? "opacity-100" : "opacity-0"}`} data-accordion="collapse">
